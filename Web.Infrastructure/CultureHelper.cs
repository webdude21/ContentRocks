namespace Web.Infrastructure
{
    ...
    {
        private static readonly List<string> Cultures = new List<string> { "en-US", "bg-BG" };
        ...
        public static string GetImplementedCulture(string name)
        {
            ...
            var cultureName = GetNeutralCulture(name);

            foreach (var culture in Cultures.Where(c => c.StartsWith(cultureName)))
            {
                return culture;
            }
